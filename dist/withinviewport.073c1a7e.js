...
},{"base64-js":"node_modules/base64-js/index.js","ieee754":"node_modules/ieee754/index.js","isarray":"node_modules/isarray/index.js","buffer":"node_modules/buffer/index.js"}],"src/withinviewport.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
exports.withinviewport = exports.withinViewportAsync = exports.withinViewport = exports.topAsync = exports.top = exports.rightAsync = exports.right = exports.leftAsync = exports.left = exports.default = exports.bottomAsync = exports.bottom = exports.__moduleExports = void 0;
  ...
  (function () {
    ...
    var runInContext = function runInContext2(context) {
      ...
      function template(string, options2, guard) {
        ...
        var imports = assignInWith({}, options2.imports, settings.imports, customDefaultsAssignIn),
...
var sides = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  ...
  function isMultipleSides(sideList) {
    ...
    return sideList.split(" ").every(function (side) {
...
var options = createCommonjsModule(function (module, exports) {
  ...
  function getConfig(methodType, elem, userOptions) {
    if (_typeof(elem) !== "object" || elem && "nodeType" in elem && elem.nodeType !== 1) {
      throw new Error("First argument must be an element");
    }
    var settings;
    if ((0, sides.isSide)(userOptions)) {
      settings = Object.assign({}, defaultSettings);
      sides.sides.forEach(function (side) {
        if (side !== userOptions) {
          settings[side] = "ignore";
        }
      });
    } else if ((0, sides.isMultipleSides)(userOptions)) {
      settings = Object.assign({}, defaultSettings);
      sides.sides.forEach(function (side) {
      ...
      settings = (0, lodash.defaults)({}, userOptions, defaultSettings);
    }
    var config = (0, lodash.defaults)({}, settings, defaultSettings);
    if (config.container === document.body || config.container && "nodeName" in config.container && config.container.nodeName === "BODY" || config.container && "nodeType" in config.container && config.container.nodeType !== 1) {
...
var rootMargin = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.determineRootMargin = void 0;
  function determineRootMargin(config, mode) {
    var ignoreValue = mode === "loose" ? -9999999 : 0;
    return sides.sides.map(function (side) {
      var value = config[side];
      return "".concat(-1 * (value === "ignore" ? ignoreValue : value), "px");
    }).join(" ");
  }
  exports.determineRootMargin = determineRootMargin;
});
var strictCallbackAndRootMargin_1 = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.strictCallbackAndRootMargin = void 0;
  function isWithinTop(entry) {
    var intersectionRect = entry.intersectionRect,
      boundingClientRect = entry.boundingClientRect;
    var isHeightAndWidthZero = intersectionRect.height === 0 && intersectionRect.width === 0;
    return !isHeightAndWidthZero && intersectionRect.y > 0 || isHeightAndWidthZero && boundingClientRect.y > 0;
  }
  function getElemWidth(elem) {
    return "clientWidth" in elem ? elem.clientWidth : window.innerWidth;
  }
  function getElemHeight(elem) {
    return "clientHeight" in elem ? elem.clientHeight : window.innerHeight;
  }
  function isWithinRight(entry, config) {
    ...
    if (isHeightAndWidthZero && boundingClientRect.right > 0 && boundingClientRect.right < getElemWidth(config.container)) {
      if (debug) {
  ...
  function isWithinBottom(entry, config) {
    var debug = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    var intersectionRect = entry.intersectionRect,
      boundingClientRect = entry.boundingClientRect;
    var isHeightAndWidthZero = intersectionRect.height === 0 && intersectionRect.width === 0;
    var containerHeight = getElemHeight(config.container);
  ...
  function isWithinLeft(entry) {
    var intersectionRect = entry.intersectionRect,
      boundingClientRect = entry.boundingClientRect;
    var isHeightAndWidthZero = intersectionRect.height === 0 && intersectionRect.width === 0;
    return !isHeightAndWidthZero && intersectionRect.x > 0 || !isHeightAndWidthZero && intersectionRect.x === 0 && boundingClientRect.x === 0 || isHeightAndWidthZero && boundingClientRect.left >= 0 && boundingClientRect.x >= 0;
  }
  function strictCallbackAndRootMargin(elem, config, resolve) {
    var debug = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : elem.getAttribute("data-boxid") === "90";
    return [function (entries, observer) {
      entries.forEach(function (entry) {
        ...
        if (!entry.isIntersecting) {
          var top2 = config.top,
            right2 = config.right,
            bottom2 = config.bottom,
            left2 = config.left;
          var numSidesPassing = 0;
          if (top2 === "ignore" || isWithinTop(entry)) {
            numSidesPassing++;
            if (debug) {
          ...
          if (right2 === "ignore" || isWithinRight(entry, config, debug)) {
            numSidesPassing++;
            if (debug) {
              console.log("right + ", right2);
            }
          } else if (debug) {
            console.log("right -");
          }
          if (bottom2 === "ignore" || isWithinBottom(entry, config, debug)) {
            numSidesPassing++;
            if (debug) {
          ...
          if (left2 === "ignore" || isWithinLeft(entry)) {
            numSidesPassing++;
            if (debug) {
      ...
      rootMargin: (0, rootMargin.determineRootMargin)(config, "strict"),
      root: config.container,
      threshold: 1
    }];
  }
  exports.strictCallbackAndRootMargin = strictCallbackAndRootMargin;
});
var options$1 = createCommonjsModule(function (module, exports) {
  ...
  function getIntersectionObserverOptions(mode, config, resolve, elem) {
    if (mode === "strict" && elem) {
      return (0, strictCallbackAndRootMargin_1.strictCallbackAndRootMargin)(elem, config, resolve);
    }
    return [function (entries, observer) {
      entries.forEach(function (entry) {
        observer.disconnect();
      ...
      rootMargin: (0, rootMargin.determineRootMargin)(config, "loose"),
      root: config.container,
      threshold: 1
    }];
  }
...
var async = createCommonjsModule(function (module, exports) {
  ...
  function withinViewportAsync2(elem, userOptions) {
    return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", new Promise(function (resolve) {
              var config = (0, options.getConfig)("async", elem, userOptions);
              var opts = (0, options$1.getIntersectionObserverOptions)("loose", config, resolve, elem);
              _construct(IntersectionObserver, _toConsumableArray(opts)).observe(elem);
            }));
          case 1:
          case "end":
  ...
  exports.withinViewportAsync = withinViewportAsync2;
});
var sync = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.withinViewport = void 0;
  function withinViewport2(elem, userOptions) {
    var containerBoundingRect;
    var containerScrollTop = 0;
    var containerScrollLeft = 0;
    var scrollBarWidths = [0, 0];
    var config = (0, options.getConfig)("sync", elem, userOptions);
    var isContainerTheWindow = config.container === window;
    ...
    return sides.sides.every(function (side) {
      return isWithin[side]();
    });
  }
  exports.withinViewport = withinViewport2;
});
var plugin = function plugin($) {
  ...
  $.extend($.expr[":"], {
    "within-viewport": function withinViewport(element) {
  ...
  $.extend($.expr[":"], {
    "within-viewport-top": function withinViewportTop(element) {
      return withinviewport(element, "top");
    },
    "within-viewport-right": function withinViewportRight(element) {
      return withinviewport(element, "right");
    },
    "within-viewport-bottom": function withinViewportBottom(element) {
      return withinviewport(element, "bottom");
    },
    "within-viewport-left": function withinViewportLeft(element) {
...
var dist = createCommonjsModule(function (module, exports) {
  ...
  var index_3 = async;
  Object.defineProperty(exports, "withinViewportAsync", {
    enumerable: true,
    get: function get() {
      return index_3.withinViewportAsync;
    }
  });
  var index_4 = sync;
  Object.defineProperty(exports, "withinViewport", {
    enumerable: true,
    get: function get() {
      return index_4.withinViewport;
    }
  });
  var plugin_js_1 = __importDefault(plugin);
  var global2 = function (scope) {
  ...
  if (global2) {
    if ("jQuery" in global2) {
      (0, plugin_js_1.default)(global2.jQuery);
    } else if ("$" in global2) {
      (0, plugin_js_1.default)(global2.$);
    }
  }
  function withinviewport2() {
    var result = (0, sync.withinViewport).apply(void 0, arguments);
    try {
  ...
  exports.withinviewport = withinviewport2;
  function top2(element) {
    return (0, sync.withinViewport)(element, "top");
  }
  exports.top = top2;
  function right2(element) {
    return (0, sync.withinViewport)(element, "right");
  }
  exports.right = right2;
  function bottom2(element) {
    return (0, sync.withinViewport)(element, "bottom");
  }
  exports.bottom = bottom2;
  function left2(element) {
    return (0, sync.withinViewport)(element, "left");
  }
  exports.left = left2;
  function topAsync2(element) {
    return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0, async.withinViewportAsync)(element, "top");
          case 2:
  ...
  exports.topAsync = topAsync2;
  function rightAsync2(element) {
    return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            return _context3.abrupt("return", (0, async.withinViewportAsync)(element, "right"));
          case 1:
          case "end":
  ...
  exports.rightAsync = rightAsync2;
  function bottomAsync2(element) {
    return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            return _context4.abrupt("return", (0, async.withinViewportAsync)(element, "bottom"));
          case 1:
          case "end":
  ...
  exports.bottomAsync = bottomAsync2;
  function leftAsync2(element) {
    return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            return _context5.abrupt("return", (0, async.withinViewportAsync)(element, "left"));
          case 1:
          case "end":
  ...
  exports.leftAsync = leftAsync2;
});
exports.__moduleExports = dist;
var __pika_web_default_export_for_treeshaking__ = /* @__PURE__ */getDefaultExportFromCjs(dist);
var bottom = dist.bottom;
exports.bottom = bottom;
var bottomAsync = dist.bottomAsync;
exports.bottomAsync = bottomAsync;
var _default = __pika_web_default_export_for_treeshaking__;
exports.default = _default;
var left = dist.left;
exports.left = left;
var leftAsync = dist.leftAsync;
exports.leftAsync = leftAsync;
var right = dist.right;
exports.right = right;
var rightAsync = dist.rightAsync;
exports.rightAsync = rightAsync;
var top = dist.top;
exports.top = top;
var topAsync = dist.topAsync;
exports.topAsync = topAsync;
var withinViewport = dist.withinViewport;
exports.withinViewport = withinViewport;
var withinViewportAsync = dist.withinViewportAsync;
exports.withinViewportAsync = withinViewportAsync;
var withinviewport$1 = dist.withinviewport;
exports.withinviewport = withinviewport$1;
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "42765" + '/');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/withinviewport.js"], null)
//# sourceMappingURL=/withinviewport.073c1a7e.js.map
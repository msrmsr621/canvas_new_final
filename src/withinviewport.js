...
var options = createCommonjsModule(function(module, exports) {
  ...
  function getConfig(methodType, elem, userOptions) {
    ...
    const config = (0, lodash.defaults)({}, settings, defaultSettings);
...
var strictCallbackAndRootMargin_1 = createCommonjsModule(function(module, exports) {
  ...
  function isWithinRight(entry, config, debug = false) {
    const {intersectionRect, boundingClientRect} = entry;
    const isHeightAndWidthZero = intersectionRect.height === 0 && intersectionRect.width === 0;
  ...
  function isWithinBottom(entry, config, debug = false) {
    const {intersectionRect, boundingClientRect} = entry;
    const isHeightAndWidthZero = intersectionRect.height === 0 && intersectionRect.width === 0;
  ...
  function strictCallbackAndRootMargin(elem, config, resolve, debug = elem.getAttribute("data-boxid") === "90") {
    return [
      (entries, observer) => {
        entries.forEach((entry) => {
          ...
          if (debug) {
            const {boundingClientRect, intersectionRect, intersectionRatio, isIntersecting: isIntersecting2, rootBounds} = entry;
            console.log(entry);
          ...
          if (!entry.isIntersecting) {
            const {top: top2, right: right2, bottom: bottom2, left: left2} = config;
  ...
  function withinViewportAsync2(elem, userOptions) {
    return __awaiter(this, void 0, void 0, function* () {
      return new Promise((resolve) => {
        const config = (0, options.getConfig)("async", elem, userOptions);
        const opts = (0, options$1.getIntersectionObserverOptions)("loose", config, resolve, elem);
...
var sync = createCommonjsModule(function(module, exports) {
  ...
  function withinViewport2(elem, userOptions) {
    ...
    const config = (0, options.getConfig)("sync", elem, userOptions);
    ...
    return sides.sides.every((side) => isWithin[side]());
  }
...
var dist = createCommonjsModule(function(module, exports) {
  ...
  var index_3 = async;
  Object.defineProperty(exports, "withinViewportAsync", {enumerable: true, get: function() {
    return index_3.withinViewportAsync;
  }});
  var index_4 = sync;
  Object.defineProperty(exports, "withinViewport", {enumerable: true, get: function() {
    return index_4.withinViewport;
  }});
  const plugin_js_1 = __importDefault(plugin);
  const global2 = function(scope) {
  ...
  function withinviewport2(...args) {
    const result = (0, sync.withinViewport)(...args);
    try {
  ...
  function topAsync2(element) {
    return __awaiter(this, void 0, void 0, function* () {
      return yield (0, async.withinViewportAsync)(element, "top");
    });
  }
  exports.topAsync = topAsync2;
  function rightAsync2(element) {
    return __awaiter(this, void 0, void 0, function* () {
      return (0, async.withinViewportAsync)(element, "right");
    });
  }
  exports.rightAsync = rightAsync2;
  function bottomAsync2(element) {
    return __awaiter(this, void 0, void 0, function* () {
      return (0, async.withinViewportAsync)(element, "bottom");
    });
  }
  exports.bottomAsync = bottomAsync2;
  function leftAsync2(element) {
    return __awaiter(this, void 0, void 0, function* () {
      return (0, async.withinViewportAsync)(element, "left");
    });
  }
...
export {dist as __moduleExports, bottom, bottomAsync, left, leftAsync, right, rightAsync, top, topAsync, withinViewport, withinViewportAsync, withinviewport$1 as withinviewport};
